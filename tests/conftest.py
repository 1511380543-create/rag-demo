...
CASE_AUDIT_META: dict[str, AuditMeta] = {
    ...
    "rag_index_fail_empty_001": AuditMeta("422", "documents 为空数组"),
    "rag_index_fail_non_pdf_001": AuditMeta("422", "仅支持 PDF 路径"),
    "rag_index_fail_file_not_found_001": AuditMeta("422", "本地文件不存在"),
    "rag_query_fail_empty_001": AuditMeta("422", "query 为空白"),
    "rag_query_fail_topk_001": AuditMeta("422", "top_k 小于 1"),
    "rag_health_ok_001": AuditMeta("200 + status=ok", "健康检查可用"),
    "rag_index_ok_001": AuditMeta("200 + indexed_count=2 + chunk_count>0", "双文档入库成功"),
